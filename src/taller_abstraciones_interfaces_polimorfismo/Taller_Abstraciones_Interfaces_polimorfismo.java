...
/**
 *Representa una clase Taller_Abstraciones_Interfaces_polimorfismo para la creación de Naves Espaciales con sus caracteristicas
 * @author julian mazo
 */
public class Taller_Abstraciones_Interfaces_polimorfismo {
    ...
    public static void main(String[] args) {
         ...
         */    
        do {
          System.out.println("Bienvenido que nave desea crear?\n");
